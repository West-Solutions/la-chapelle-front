  ...
  return (
    <div className={`w-full flex ${linkPosition}`}>
      <a
        href={src}
        target={"_blank"}
        className={`bg-${color} w-full max-w-lg flex items-center gap-2 justify-center text-center text-white text-lg p-2 font-bold rounded-lg hover:opacity-90 shadow-lg hover:shadow-normal transition-all`}
        rel="noreferrer"
      >

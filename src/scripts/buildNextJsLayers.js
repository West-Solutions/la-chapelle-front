...
const pageTemplate = item => {
  ...
  return `/*
[...${path}]-page:${pageId}
This page is generated by the build script and should not be edited directly.
*/
...
const _nextJSPageTemplate = p =>  <PageRenderer {...p} />;
...
export default _nextJSPageTemplate;
`;
};
